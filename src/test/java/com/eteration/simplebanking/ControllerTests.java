...
class ControllerTests {
    ...
    public void givenId_Credit_thenReturnJson()
        ...
        doReturn(account).when(service).updateAccount(account);
        ...
        assertEquals("OK", result.getBody().getStatus().toString());
    }
    ...
    public void givenId_CreditAndThenDebit_thenReturnJson()
        ...
        assertEquals("OK", result.getBody().getStatus().toString());
        assertEquals("OK", result2.getBody().getStatus().toString());
